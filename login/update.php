...
if (isset($_POST["submit"])) {
  ...
  if ($pictureArray->error === 0) {
      ...
      $sql = "UPDATE users SET firstName = '$fName', lastName = '$lName', address = '$address', email = '$email', phoneNumber = '$phoneNumber', picture = '$pictureArray->fileName' WHERE id = {$id}";
  } else {
      $sql = "UPDATE users SET firstName = '$fName', lastName = '$lName', address = '$address', email = '$email', phoneNumber = '$phoneNumber' WHERE id = {$id}";
  }
  ...
  <div class="container">
      ...
      <form method="post" enctype="multipart/form-data">
          <table class="table">
              <tr>
                  <th>First Name</th>
                  <td><input class="form-control" type="text" name="firstName" placeholder="First Name" value="<?php echo $fName ?>" /></td>
              </tr>
              <tr>
                  <th>Last Name</th>
                  <td><input class="form-control" type="text" name="lastName" placeholder="Last Name" value="<?php echo $lName ?>" /></td>
              </tr>
              <tr>
                  <th>Address</th>
              ...
              <tr>
                  <th>Phone number</th>
                  <td><input class="form-control" type="number" name="phoneNumber" placeholder="Phone number" value="<?php echo $phoneNumber ?>" /></td>
              </tr>
              <tr>
                  <th>Picture</th>
